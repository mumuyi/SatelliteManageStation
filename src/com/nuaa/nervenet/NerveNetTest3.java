...
public class NerveNetTest3 implements NeuralNetListener, java.io.Serializable{
...
//	private static String filename="C:/Users/ai/Desktop/data/model/modelyjs088.nnet";
	...
	public static void main(String args[]) {
		...
		NerveNetTest3 bp = new NerveNetTest3();  
		...
		//for(int i=0;i<100;i++){
		//	System.out.println(""+(-4*i*i+400*i));
		//}
	}
