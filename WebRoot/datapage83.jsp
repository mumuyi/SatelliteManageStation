...
<html>
	...
	<script>
		...
		function TableInit(){
					...
					$("#table_list").jqGrid(
					{
						url:'${ctx}/MainContentController/getData/8-3', 
						datatype : "json",
						postData:{
						...
						rowNum:10,
						rowList:[10,20,30],
						colNames:["星上时间 秒","星上时间 毫秒","太阳电池阵梯形板1温度","太阳电池阵梯形板2温度","太阳电池阵梯形板4温度","蓄电池1温度","蓄电池2温度","蓄电池4温度","能源控制板温度"],
						colModel:[
									...
									{name:"ywd119",index:"ywd119",editable:true,width:100,align:"center",sorttype:"text",search:true},
									{name:"ywd120",index:"ywd120",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"ywd121",index:"ywd121",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"ywd122",index:"ywd122",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"ywd123",index:"ywd123",editable:true,width:100,align:"center",sorttype:"text",search:true},
									{name:"ywd124",index:"ywd124",editable:true,width:100,align:"center",sorttype:"text",search:true},
									{name:"ywd125",index:"ywd125",editable:true,width:100,align:"center",sorttype:"text",search:true},
						],
	...
	<script>
		...
		function TableInit1(){
					...
					$("#table_list1").jqGrid(
					{
						url:'${ctx}/MainContentController/getTableShowData/8-3-1', 
						datatype : "json",
						postData:{
