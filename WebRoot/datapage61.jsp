...
<html>
	...
	<script>
		...
		function TableInit(){
					...
					$("#table_list").jqGrid(
					{
						url:'${ctx}/MainContentController/getData/6-1', 
						datatype : "json",
						postData:{
						...
						rowNum:10,
						rowList:[10,20,30],
						colNames:["星上时间 秒","星上时间 毫秒","磁强计A X轴输出","磁强计A Y轴输出","磁强计A Z轴输出","磁强计B X轴输出","磁强计B Y轴输出","磁强计B Z轴输出"],
						colModel:[
									...
									{name:"yca002",index:"yca002",editable:true,width:100,align:"center",sorttype:"text",search:true},
									{name:"yca003",index:"yca003",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"yca004",index:"yca004",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"ycb005",index:"ycb005",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"ycb006",index:"ycb006",editable:true,width:100,align:"center",sorttype:"text",search:true},
									{name:"ycb007",index:"ycb007",editable:true,width:100,align:"center",sorttype:"text",search:true},
						],
	...
	<script>
		...
		function TableInit1(){
					...
					$("#table_list1").jqGrid(
					{
						url:'${ctx}/MainContentController/getTableShowData/6-1-1', 
						datatype : "json",
						postData:{
