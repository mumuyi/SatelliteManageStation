	...
	websocket.onmessage = function() {
		...
		var v1=jsonObj[0].ywd119;
		v1=v1-0.1;
		var v2=jsonObj[0].ywd120;
		v2=v2-0.1;
		var v3=jsonObj[0].ywd121;
		v3=v3-0.1;
		var v4=jsonObj[0].ywd122;
		v4=v4-0.1;
		var v5=jsonObj[0].ywd123;
		v5=v5-0.1;
		var v6=jsonObj[0].ywd124;
		v6=v6-0.1;
		var v7=jsonObj[0].ywd125;
		v7=v7-0.1;
		var v8=jsonObj[0].ysj023;
		var v9=jsonObj[0].ysj024;
		//添加数据;
		var chart = $('#ywd119').highcharts();
		chart.series[0].addPoint([ (new Date()).getTime(), v1+0.1 ]);
		var chart2 = $('#ywd120').highcharts();
		chart2.series[0].addPoint([ (new Date()).getTime(), v2+0.1 ]);
		var chart3 = $('#ywd121').highcharts();
		chart3.series[0].addPoint([ (new Date()).getTime(), v3+0.1 ]);
		var chart4 = $('#ywd122').highcharts();
		chart4.series[0].addPoint([ (new Date()).getTime(), v4+0.1 ]);
		var chart5 = $('#ywd123').highcharts();
		chart5.series[0].addPoint([ (new Date()).getTime(), v5+0.1 ]);
		var chart6 = $('#ywd124').highcharts();
		chart6.series[0].addPoint([ (new Date()).getTime(), v6+0.1 ]);
		var chart7 = $('#ywd125').highcharts();
