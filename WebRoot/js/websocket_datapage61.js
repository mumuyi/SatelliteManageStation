	...
	websocket.onmessage = function() {
		...
		var v1=jsonObj[0].yca002;
		v1=v1-0.1;
		var v2=jsonObj[0].yca003;
		v2=v2-0.1;
		var v3=jsonObj[0].yca004;
		v3=v3-0.1;
		var v4=jsonObj[0].ycb005;
		v4=v4-0.1;
		var v5=jsonObj[0].ycb006;
		v5=v5-0.1;
		var v6=jsonObj[0].ycb007;
		v6=v6-0.1;
		var v7=jsonObj[0].ysj023;
		var v8=jsonObj[0].ysj024;
		//添加数据;
		var chart = $('#yca002').highcharts();
		chart.series[0].addPoint([ (new Date()).getTime(), v1+0.1 ]);
		var chart2 = $('#yca003').highcharts();
		chart2.series[0].addPoint([ (new Date()).getTime(), v2+0.1 ]);
		var chart3 = $('#yca004').highcharts();
		chart3.series[0].addPoint([ (new Date()).getTime(), v3+0.1 ]);
		var chart4 = $('#ycb005').highcharts();
		chart4.series[0].addPoint([ (new Date()).getTime(), v4+0.1 ]);
		var chart5 = $('#ycb006').highcharts();
		chart5.series[0].addPoint([ (new Date()).getTime(), v5+0.1 ]);
		var chart6 = $('#ycb007').highcharts();
