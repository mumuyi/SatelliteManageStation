	...
	websocket.onmessage = function() {
		...
		var v1=jsonObj[0].ytx070;
		v1=v1-0.1;
		var v2=jsonObj[0].ytx071;
		v2=v2-0.1;
		var v3=jsonObj[0].ytx072;
		v3=v3-0.1;
		var v4=jsonObj[0].ytx073;
		v4=v4-0.1;
		var v5=jsonObj[0].ytx074;
		v5=v5-0.1;
		var v7=jsonObj[0].ysj023;
		var v8=jsonObj[0].ysj024;
		//添加数据;
		var chart = $('#ytx070').highcharts();
		chart.series[0].addPoint([ (new Date()).getTime(), v1+0.1 ]);
		var chart2 = $('#ytx071').highcharts();
		chart2.series[0].addPoint([ (new Date()).getTime(), v2+0.1 ]);
		var chart3 = $('#ytx072').highcharts();
		chart3.series[0].addPoint([ (new Date()).getTime(), v3+0.1 ]);
		var chart4 = $('#ytx073').highcharts();
		chart4.series[0].addPoint([ (new Date()).getTime(), v4+0.1 ]);
		var chart5 = $('#ytx074').highcharts();
