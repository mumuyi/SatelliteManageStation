	...
	websocket.onmessage = function() {
		...
		var v1=jsonObj[0].ygp026;
		v1=v1-0.1;
		var v2=jsonObj[0].ygp027;
		v2=v2-0.1;
		var v3=jsonObj[0].ygp028;
		v3=v3-0.1;
		var v4=jsonObj[0].ygp029;
		v4=v4-0.1;
		var v5=jsonObj[0].ygp030;
		v5=v5-0.1;
		var v6=jsonObj[0].ygp031;
		v6=v6-0.1;
		//添加数据;
		var chart = $('#ygp026').highcharts();
		chart.series[0].addPoint([ (new Date()).getTime(), v1+0.1 ]);
		var chart2 = $('#ygp027').highcharts();
		chart2.series[0].addPoint([ (new Date()).getTime(), v2+0.1 ]);
		var chart3 = $('#ygp028').highcharts();
		chart3.series[0].addPoint([ (new Date()).getTime(), v3+0.1 ]);
		var chart4 = $('#ygp029').highcharts();
		chart4.series[0].addPoint([ (new Date()).getTime(), v4+0.1 ]);
		var chart5 = $('#ygp030').highcharts();
		chart5.series[0].addPoint([ (new Date()).getTime(), v5+0.1 ]);
		var chart6 = $('#ygp031').highcharts();
