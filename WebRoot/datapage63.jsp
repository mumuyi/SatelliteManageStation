...
<html>
	...
	<script>
		...
		function TableInit(){
					...
					$("#table_list").jqGrid(
					{
						url:'${ctx}/MainContentController/getData/6-3', 
						datatype : "json",
						postData:{
						...
						rowNum:10,
						rowList:[10,20,30],
						colNames:["星上时间 秒","星上时间 毫秒","GPS轨道X位置","GPS轨道Y位置","GPS轨道Z位置","GPS轨道X速度","GPS轨道Y速度","GPS轨道Z速度"],
						colModel:[
									...
									{name:"ygp026",index:"ygp026",editable:true,width:100,align:"center",sorttype:"text",search:true},
									{name:"ygp027",index:"ygp027",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"ygp028",index:"ygp028",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"ygp029",index:"ygp029",editable:true,width:80,align:"center",sorttype:"text",search:true},
									{name:"ygp030",index:"ygp030",editable:true,width:100,align:"center",sorttype:"text",search:true},
									{name:"ygp031",index:"ygp031",editable:true,width:100,align:"center",sorttype:"text",search:true},
						],
	...
	<script>
		...
		function TableInit1(){
					...
					$("#table_list1").jqGrid(
					{
						url:'${ctx}/MainContentController/getTableShowData/6-3-1', 
						datatype : "json",
						postData:{
