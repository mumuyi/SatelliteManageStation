...
!function(a) {
	...
	$.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
			...
			if (void 0 === d && (d = $.jgrid.getRegional(this, "formatter.date")), void 0 === d.parseRe && (d.parseRe = /[#%\\\/:_;.,\t\s-]/), d.masks.hasOwnProperty(a) && (a = d.masks[a]), b && null != b)
				if (isNaN(b - 0) || "u" !== String(a).toLowerCase())
					if (b.constructor === Date)
						o = b;
					else if (null !== l) o = new Date(parseInt(l[1], 10)), l[3] && (q = 60 * Number(l[5]) + Number(l[6]), q *= "-" === l[4] ? 1 : -1, q -= o.getTimezoneOffset(), o.setTime(Number(Number(o) + 60 * q * 1e3)));else {
		...
		clearBeforeUnload : function(a) {
			...
			if (c.grid) {
				...
				for (e = f.length, d = 0; e > d; d++) c.hasOwnProperty(f[d]) && (c[f[d]] = null,
					delete c[f[d]]
				)
			}
		},
		...
		gridDestroy : function(a) {
			if (a) {
				...
				var b = $("#" + $.jgrid.jqID(a))[0];
				if (b.grid) {
					b.p.pager && $(b.p.pager).remove();try {
		...
		return this.each(function() {
			if (!this.grid) {
				...
				var w,
					...
					L = function(a, b, c, e) {
						...
						if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
							...
							if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
								e && (T *= e + 1);
								var V,
									W = $.isFunction(d.p.afterInsertRow),
									X = !1,
								...
								for (d.p.grouping && (X = d.p.groupingView.groupCollapse === !0, V = $.jgrid.getMethod("groupingPrepare")); Q > R;) {
									t = O[R], u = r(t, U + R), u = d.p.idPrefix + u, P = 0 === b ? 0 : b + 1, v = N + ((P + R) % 2 === 1 ? " " + M : "");var ab = L.length;
					...
					M = function(a, b, c, e) {
						...
						if (a) {
							...
							var Y,
								Z = $.isFunction(d.p.afterInsertRow),
								_ = [],
								ab = !1,
							...
							for (d.p.grouping && (ab = d.p.groupingView.groupCollapse === !0, Y = $.jgrid.getMethod("groupingPrepare")); t > o;) {
								...
								x = d.p.idPrefix + x, T = 1 === b ? 0 : b, z = S + ((T + o) % 2 === 1 ? " " + R : ""), X && (U = d.p.multiselect ? -1 !== $.inArray(x, d.p.selarrrow) : x === d.p.selrow);var fb = Q.length;
					...
					O = function(a, b) {
						...
						if (p = d.p.pager || "", p += d.p.toppager ? p ? "," + d.p.toppager : d.p.toppager : "") {
							if (j = $.jgrid.getRegional(d, "formatter.integer"), c = y(d.p.page), e = y(d.p.lastpage), $(".selbox", p)[this.p.useProp ? "prop" : "attr"]("disabled", !1), d.p.pginput === !0 && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input " + k(l, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "'></span>")), d.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input " + k(l, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>")), $(".ui-pg-input", p).val(d.p.page), n = d.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(n).html($.fmatter ? $.fmatter.util.NumberFormat(d.p.lastpage, j) : d.p.lastpage)), d.p.viewrecords)
								if (0 === d.p.reccount) $(".ui-paging-info", p).html($.jgrid.getRegional(d, "defaults.emptyrecords", d.p.emptyrecords));else {
					...
					R = function(a) {
						if (!d.grid.hDiv.loading) {
							...
							case "script":
								...
								break;case "local":
							case "clientside":
								P(), d.p.datatype = "local", d.p._ald = !0;var q = N();
					...
					T = function(a, b) {
						var c,
							...
							j,
							n,
							p = "<td class='ui-pg-button " + m + "'><span class='ui-separator'></span></td>",
							r = "",
					...
					V = function(a, b, c, e, f) {
						if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
							if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort) U(b, f);else {
								...
								var g,
									h = d.grid.headers[d.p.lastsort] ? d.grid.headers[d.p.lastsort].el : null,
				...
				if (d.p.sortorder = d.p.sortorder.toLowerCase(), $.jgrid.cell_width = $.jgrid.cellWidth(), d.p.grouping === !0 && (d.p.scroll = !1, d.p.rownumbers = !1, d.p.treeGrid = !1, d.p.gridview = !0), this.p.treeGrid === !0) {
					...
					} catch (_) {} "local" !== d.p.datatype && (d.p.localReader = {
						id : "_id_"
					})
				}
				if (this.p.subGrid) try {
						$(d).jqGrid("setSubGrid")
					} catch (ab) {} this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>"), this.p.colModel.unshift({
					name : "cb",
				...
				var bb,
					...
					hb,
					ib,
					jb = "<thead><tr class='ui-jqgrid-labels' role='row'>",
					kb = "",
					lb = "",
					mb = "";
				if (d.p.shrinkToFit === !0 && d.p.forceFit === !0)
					for (i = d.p.colModel.length - 1; i >= 0; i--)
						if (!d.p.colModel[i].hidden) {
							d.p.colModel[i].resizable = !1;break
				}
				...
				if (d.p.disableClick = !1, $("th", sb).each(function(a) {
					...
					} catch (ub) {} d.p.footerrow && (rb += "</tr></tbody></table>"), tb += "</tr>", hb = document.createElement("tbody"), this.appendChild(hb), $(this).addClass(k(l, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(tb), tb = null;
				...
				$(d).before(e.hDiv).click(function(a) {
					...
					if ("A" !== fb.tagName && ("INPUT" !== fb.tagName && "TEXTAREA" !== fb.tagName && "OPTION" !== fb.tagName && "SELECT" !== fb.tagName || b)) {
						if (yb = gb[0].id, fb = $(fb).closest("tr.jqgrow>td"), fb.length > 0 && (zb = $.jgrid.getCellIndex(fb), Ab = $(fb).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [ yb, zb, Ab, a ]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, yb, zb, Ab, a)), d.p.cellEdit === !0)
							if (d.p.multiselect && b && c) $(d).jqGrid("setSelection", yb, !0, a);
								...
								yb = gb[0].rowIndex;try {
									$(d).jqGrid("editCell", yb, zb, !0)
								} catch (f) {}
						}
						if (c)
							if (d.p.multikey)
								a[d.p.multikey] ? $(d).jqGrid("setSelection", yb, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + yb).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + yb)[d.p.useProp ? "prop" : "attr"]("checked", !b));
							else if (d.p.multiselect && d.p.multiboxonly)
								if (b) $(d).jqGrid("setSelection", yb, !0, a);else {
					...
					return d.grid.prevRowHeight && d.p.scroll && void 0 === b.page ? (
							delete d.p.lastpage
							, d.grid.populateVisible()) : d.grid.populate(), d.p.inlineNav === !0 && $(d).jqGrid("showAddEditButtons"), !1
				}).dblclick(function(a) {
				...
				if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width).insertBefore(e.hDiv), T(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], xb = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(xb).width(e.width).insertAfter(e.hDiv), $(xb).append(rb), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")), wb && $(e.sDiv).hide()), xb = null, d.p.caption) {
					...
					d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
						var b,
							c = $.isFunction(d.p.onHeaderClick),
					...
					for (b && b === !0 && j.p.data.length > 0 || (b = !1); d > g;) f && (i = j.rows[g]), $(i).hasClass("jqgrow") && (b ? e = j.p.data[j.p._index[i.id]] : $('td[role="gridcell"]', i).each(function(a) {
							if (h = j.p.colModel[a].name, "cb" !== h && "subgrid" !== h && "rn" !== h)
								if (j.p.treeGrid === !0 && h === j.p.ExpandColumn)
									e[h] = $.jgrid.htmlDecode($("span:first", this).html());else try {
					...
					if (b) try {
							if ($(this.p.colModel).each(function(c) {
								...
								var l,
									...
									n = i.p._index[m];
								if (i.p.treeGrid)
									for (l in i.p.treeReader) i.p.treeReader.hasOwnProperty(l) &&
		...
		setCell : function(a, b, c, d, e, f) {
			//alert("I am setCell(a,b,c,d,e,f)");
			return this.each(function() {
				var g,
					h,
					i = this,
			...
			return this.each(function() {
				if (this.grid && b) {
					...
					for (c = 0; c < d.length; c++)
						if (d[c].name === a) {
							$.extend(!0, this.p.colModel[c], b);break
					}
				}
			})
		},
				...
				if (e.grid) {
					for (a || (a = e.p.sortname), d = 0; d < e.p.colModel.length; d++)
						if (e.p.colModel[d].index === a || e.p.colModel[d].name === a) {
							f = d, e.p.frozenColumns === !0 && e.p.colModel[d].frozen === !0 && (g = e.grid.fhDiv.find("#" + e.p.id + "_" + a));break
					}
					if (-1 !== f) {
				...
				if (h.grid && h.p.cellEdit === !0) {
					...
					if (g = h.p.colModel[b], d = g.name, "subgrid" !== d && "cb" !== d && "rn" !== d) {
						if (f = $("td:eq(" + b + ")", h.rows[a]), g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b)) parseInt(h.p.iCol, 10) >= 0 && parseInt(h.p.iRow, 10) >= 0 && $(h.rows[h.p.iRow]).removeClass("selected-row " + j).find("td:eq(" + h.p.iCol + ")").removeClass("edit-cell " + i), f.addClass("edit-cell " + i), $(h.rows[a]).addClass("selected-row " + j), e = f.html().replace(/\&#160\;/gi, ""), $(h).triggerHandler("jqGridSelectCell", [ h.rows[a].id, d, e, a, b ]), $.isFunction(h.p.onSelectCell) && h.p.onSelectCell.call(h, h.rows[a].id, d, e, a, b);else {
							parseInt(h.p.iCol, 10) >= 0 && parseInt(h.p.iRow, 10) >= 0 && $(h.rows[h.p.iRow]).removeClass("selected-row " + j).find("td:eq(" + h.p.iCol + ")").removeClass("edit-cell " + i), $(f).addClass("edit-cell " + i), $(h.rows[a]).addClass("selected-row " + j);try {
								e = $.unformat.call(h, f, {
									rowId : h.rows[a].id,
									colModel : g
								}, b)
						...
						case "button":
							...
							try {
								if (!j.editoptions || !$.isFunction(j.editoptions.custom_value))
									throw "e1";
								if (g = j.editoptions.custom_value.call(d, $(".customelement", i), "get"), void 0 === g)
									throw "e2";
								h = g
							} catch (p) {
							...
							if (s[0] === !0) {
								...
								if ($.isFunction(d.p.beforeSubmitCell) && (t = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b), t || (t = {})), $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"), "remote" === d.p.cellsubmit)
									if (d.p.cellurl) {
										...
										} catch (p) {}"clientArray" === d.p.cellsubmit && ($(i).empty(), $(d).jqGrid("setCell", d.rows[a].id, b, h, !1, !1, !0), $(i).addClass("dirty-cell"), $(d.rows[a]).addClass("edited"), $(d).triggerHandler("jqGridAfterSaveCell", [ d.rows[a].id, k, g, a, b ]), $.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.rows[a].id, k, g, a, b), d.p.savedRow.splice(0, 1))
							} else try {
				...
				if (d.grid && d.p.cellEdit === !0) {
					if (c = d.p.savedRow.length >= 1 ? 0 : null, null !== c) {
						...
						if ($.isFunction($.fn.datepicker)) try {
							...
							} catch (f) {} $(e).empty().attr("tabindex", "-1"), $(d).jqGrid("setCell", d.rows[a].id, b, d.p.savedRow[c].v, !1, !1, !0), $(d).triggerHandler("jqGridAfterRestoreCell", [ d.rows[a].id, d.p.savedRow[c].v, a, b ]), $.isFunction(d.p.afterRestoreCell) && d.p.afterRestoreCell.call(d, d.rows[a].id, d.p.savedRow[c].v, a, b), d.p.savedRow.splice(0, 1)
					}
					window.setTimeout(function() {
		...
		hideModal : function(a, b) {
			...
			if ($.fn.jqm && b.jqm === !0) $(a).attr("aria-hidden", "true").jqmHide();else {
				if ("" !== b.gb) try {
					...
					} catch (i) {} $(a).hide().attr("aria-hidden", "true")
			}
		...
		createModal : function(a, b, c, d, e, f, g) {
			...
			if (i && p.left && !f && (s = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8, p.left = parseInt(p.left, 10) + parseInt(s, 10)), p.left && (p.left += "px"), $(l).css($.extend({
				...
				if ($(m).css("cursor", "move"), $.fn.jqDrag) $(l).jqDrag(m);else try {
						$(l).draggable({
							handle : $("#" + $.jgrid.jqID(m.id))
						})
					} catch (t) {}
			if (c.resize)
				if ($.fn.jqResize) $(l).append("<div class='jqResize " + j.resizable + " " + k.icon_base + " " + j.icon_resizable + "'></div>"), $("#" + $.jgrid.jqID(a.themodal)).jqResize(".jqResize", a.scrollelm ? "#" + $.jgrid.jqID(a.scrollelm) : !1);else try {
						$(l).resizable({
							handles : "se, sw",
							alsoResize : a.scrollelm ? "#" + $.jgrid.jqID(a.scrollelm) : !1
						})
					} catch (u) {}c.closeOnEscape === !0 && $(l).keydown(function(b) {
				if (27 === b.which) {
		...
		viewModal : function(a, b) {
			if (b = $.extend({
					...
					jqm : !0,
					jqM : !0
				}, b || {}), void 0 === b.focusField && (b.focusField = 0), b.focusField = "number" == typeof b.focusField && b.focusField >= 0 ? parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? 0 : !1, $.fn.jqm && b.jqm === !0)
		...
		info_dialog : function(a, b, c, d) {
			...
			n += "<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:" + l + ";" + m + "'>" + b + "</div>", n += c ? "<div class='" + h.header + "' style='text-align:" + e.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a id='closedialog' class='fm-button " + i.button + "'>" + c + "</a>" + k + "</div>" : "" !== k ? "<div class='" + h.header + "' style='text-align:" + e.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>" + k + "</div>" : "", n += "</div>";try {
				...
				modal : e.modal,
				jqm : f
			}), $.isFunction(e.afterOpen) && e.afterOpen();try {
				$("#info_dialog").focus()
			} catch (p) {}
		},
		bindEv : function(a, b) {
		...
		createEl : function(a, b, c, d, e) {
			...
			case "textarea":
				...
				break;case "select":
				g = document.createElement("select"), g.setAttribute("role", "select");var k,
					l = [];
				if (b.multiple === !0 ? (k = !0, g.multiple = "multiple", $(g).attr("aria-multiselectable", "true")) : k = !1, null != b.dataUrl) {
					...
					try {
						m = b.rowId
					} catch (o) {} h.p && h.p.idPrefix && (m = $.jgrid.stripPref(h.p.idPrefix, m)), $.ajax($.extend({
					...
					var q,
						...
						u,
						v,
						w = void 0 === b.separator ? ":" : b.separator,
			...
			case "file":
				...
				break;case "custom":
				g = document.createElement("span");try {
			...
			if (void 0 === c)
				if ("string" == typeof b) {
					for (f = 0, i = l.length; i > f; f++)
						if (l[f].name === b) {
							e = l[f].editrules, b = f, null != l[f].formoptions && (g = l[f].formoptions.label);break
					}
					...
					this.onchange = function() {
						...
						if (void 0 !== a.groups)
							for (c = 0; c < a.groups.length; c++) {
								var s = $("<tr></tr>");
								f.append(s);var t = $("<td class='first'></td>");
								s.append(t);var u = $("<td colspan='4'></td>");
						...
						o.append(q);
						var r,
							s = $("<select class='" + h.srSelect + "'></select>"),
							t = [];
						...
						for (b = 0; b < this.p.ops.length; b++)
							if (this.p.ops[b].oper === a.op) {
								g = this.p.operands.hasOwnProperty(a.op) ? this.p.operands[a.op] : "", h = this.p.ops[b].oper;break
						}
						for (b = 0; b < this.p.columns.length; b++)
							if (this.p.columns[b].name === a.field) {
								c = this.p.columns[b];break
						}
		...
		filterToolbar : function(a) {
			...
			return a = $.extend({
					...
					if (!c.p.filterToolbar) {
						...
						var d,
							e = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
						...
						if (a.styleUI = c.p.styleUI, "string" == typeof i && (i = $.jgrid.parse(i)), a.recreateFilter === !0 && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0]) b($("#fbox_" + $.jgrid.jqID(c.p.id)));else {
							...
							v = !1, a.tmplNames && a.tmplNames.length && (v = !0, u = "<tr><td class='ui-search-label'>" + a.tmplLabel + "</td>", u += "<td><select class='ui-template " + j.srSelect + "'>", u += "<option value='default'>Default</option>", $.each(a.tmplNames, function(a, b) {
								...
								if (a.stringResult) {
									try {
										b = JSON.stringify(f)
									} catch (j) {} "string" == typeof b && (i[a.sFilter] = b, $.each([ a.sField, a.sValue, a.sOper ], function() {
										i[this] = ""
									}))
								} else
									a.multipleSearch ? (i[a.sFilter] = f, $.each([ a.sField, a.sValue, a.sOper ], function() {
										i[this] = ""
	...
	if ($.jgrid.extend({
				...
				return b = $.extend(!0, {
									...
									if (a.length) {
										...
										$.each(p.p.colModel, function() {
											if (this.name === c && this.editoptions && $.isFunction(this.editoptions.custom_value)) {
												try {
													if (r[c] = this.editoptions.custom_value.call(p, $("#" + $.jgrid.jqID(c), x), "get"), void 0 === r[c])
														throw "e1"
												} catch (a) {
										...
										case "checkbox":
											...
											r[this.name] = $(this).val(), r[this.name] = r[this.name] ? r[this.name].join(",") : "";var e = [];
							...
							if ("_empty" !== a && (o = $(b).jqGrid("getInd", a)), $(b.p.colModel).each(function(l) {
									if (f = this.name, g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, j = g ? "style='display:none'" : "", "cb" !== f && "subgrid" !== f && this.editable === !0 && "rn" !== f) {
										if (o === !1)
											...
											i = $("td[role='gridcell']:eq(" + l + ")", b.rows[o]).text();else {
											try {
						...
						function g(a, b, c) {
							var d,
								...
								i,
								j = 0;
							(rp_ge[p.p.id].checkOnSubmit || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData = {}, rp_ge[p.p.id]._savedData[b.p.id + "_id"] = a);var k = b.p.colModel;
						...
						function i() {
							...
							if (h(), l[0] && (m = $(p).triggerHandler("jqGridAddEditClickSubmit", [ rp_ge[p.p.id], r, t ]), void 0 === m && $.isFunction(rp_ge[p.p.id].onclickSubmit) && (m = rp_ge[p.p.id].onclickSubmit.call(p, rp_ge[p.p.id], r, t) || {}), l = $(p).triggerHandler("jqGridAddEditBeforeSubmit", [ r, $(v), t ]), void 0 === l && (l = [ !0, "", "" ]), l[0] && $.isFunction(rp_ge[p.p.id].beforeSubmit) && (l = rp_ge[p.p.id].beforeSubmit.call(p, r, $(v), t))), l[0] && !rp_ge[p.p.id].processing) {
								if (rp_ge[p.p.id].processing = !0, $("#sData", x + "_2").addClass(f.active), k = rp_ge[p.p.id].url || $(p).jqGrid("getGridParam", "editurl"), d = n.oper, c = "clientArray" === k ? p.p.keyName : n.id, r[d] = "_empty" === $.trim(r[p.p.id + "_id"]) ? n.addoper : n.editoper, r[d] !== n.addoper ? r[c] = r[p.p.id + "_id"] : void 0 === r[c] && (r[c] = r[p.p.id + "_id"]),
									delete r[p.p.id + "_id"]
									, r = $.extend(r, rp_ge[p.p.id].editData, m), p.p.treeGrid === !0) {
									if (r[d] === n.addoper) {
								...
								if (w.url || rp_ge[p.p.id].useDataProxy || ($.isFunction(p.p.dataProxy) ? rp_ge[p.p.id].useDataProxy = !0 : (l[0] = !1, l[1] += " " + D.nourl)), l[0])
									if (rp_ge[p.p.id].useDataProxy) {
										...
										"clientArray" === w.url ? (rp_ge[p.p.id].reloadAfterSubmit = !1, r = w.data, w.complete({
											status : 200,
											statusText : ""
										}, "")) : $.ajax(w)
							}
				...
				return b = $.extend(!0, {
						...
						if (c.grid && a) {
							var d,
								...
								h,
								i,
								j = $.isFunction(rp_ge[c.p.id].beforeShowForm),
									...
									if (n = {}, $.isFunction(rp_ge[c.p.id].onclickSubmit) && (n = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], j) || {}), $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, j)), e[0] && !rp_ge[c.p.id].processing) {
										...
										if (k.url || rp_ge[c.p.id].useDataProxy || ($.isFunction(c.p.dataProxy) ? rp_ge[c.p.id].useDataProxy = !0 : (e[0] = !1, e[1] += " " + $.jgrid.getRegional(c, "errors.nourl"))), e[0])
											if (rp_ge[c.p.id].useDataProxy) {
												...
												"clientArray" === k.url ? (d = k.data, k.complete({
													status : 200,
													statusText : ""
												}, "")) : $.ajax(k)
									}
							...
							if (o.grid && "string" == typeof a) {
								...
								for (m.cloneToTop && o.p.toppager && (q = 2), p = 0; q > p; p++) {
									...
									0 === p ? (u = a, v = o.p.id, u === o.p.toppager && (v += "_top", q = 1)) : (u = o.p.toppager, v = o.p.id + "_top"), "rtl" === o.p.direction && $(w).attr("dir", "rtl").css("float", "right"), d = d || {}, m.add && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"), $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.addicon + "'></span>" + m.addtext + "</div>"), $("tr", w).append(t), $(t, w).attr({
										...
										if (!$(this).hasClass(k.disabled)) {
											$.isFunction(m.beforeRefresh) && m.beforeRefresh.call(o), o.p.search = !1, o.p.resetsearch = !0;try {
												if ("currentfilter" !== m.refreshstate) {
													var a = o.p.id;
													o.p.postData.filters = "";try {
														$("#fbox_" + $.jgrid.jqID(a)).jqFilter("resetFilter")
													} catch (b) {} $.isFunction(o.clearToolbar) && o.clearToolbar.call(o, !1)
												}
											} catch (c) {} switch (m.refreshstate) {
											case "firstpage":
				...
				return this.each(function() {
					...
					var o = {
						...
						p = function() {
							var a,
								j,
								n = $(".ui-jqgrid-view").css("font-size") || "11px",
							...
							c.add && (e = e || {}, a = e.id || "add_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.addtext || c.addtitle) + "</a></li>").click(function() {
								...
								if (!$(this).hasClass(l.disabled)) {
									$.isFunction(c.beforeRefresh) && c.beforeRefresh.call(i), i.p.search = !1, i.p.resetsearch = !0;try {
										if ("currentfilter" !== c.refreshstate) {
											var a = i.p.id;
											i.p.postData.filters = "";try {
												$("#fbox_" + $.jgrid.jqID(a)).jqFilter("resetFilter")
											} catch (b) {} $.isFunction(i.clearToolbar) && i.clearToolbar.call(i, !1)
										}
									} catch (d) {} switch (c.refreshstate) {
									case "firstpage":
			...
			groupingRender : function(a, b, c, d) {
				return this.each(function() {
					...
					function f(a, c, d, f) {
						...
						for (h = f; b > h; h++) {
							...
							$.each(i.summary, function() {
								if (this.nm === k[h].name) {
									k[h].summaryTpl && (o = k[h].summaryTpl), "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && l > 0 && (this.v = this.v / l));try {
					...
					t.reverse(), r = j.p.multiselect ? ' colspan="2"' : "", $.each(k.groups, function(e, u) {
						...
						s++, h = j.p.id + "ghead_" + u.idx, g = h + "_" + e, m = "<span style='cursor:pointer;margin-right:8px;margin-left:5px;' class='" + q.icon_base + " " + n + "' onclick=\"jQuery('#" + $.jgrid.jqID(j.p.id) + "').jqGrid('groupingToggle','" + g + "');return false;\"></span>";try {
				...
				return void 0 === a && (a = !0), this.each(function() {
						...
						if (j) {
							for ($(this).unbind(".setGroupHeaders"), b = $("<tr>", {
								...
								h = l[c].hidden ? "none" : "", f = $(e[c].el).width(e[c].width).css("display", h);try {
				...
				if (c = $.extend({
					...
					if (b) {
						...
						if (d = jqGridUtils.parse(b), d && "object" === $.type(d)) {
							...
							d.shrinkToFit = !1, d.data = [], d.datatype = "local", d.grouping = !1, d.navGrid = !1, d.inlineNav && (g = k(d._iN), d._iN = null,
							delete d._iN
							), d.filterToolbar && (h = k(d._fT), d._fT = null,
							delete d._fT
							);
							var m = $("#" + a).jqGrid(d);
			...
			jqGridExport : function(a) {
				...
				return this.each(function() {
						if (this.grid) {
							var c,
								d = $.extend(!0, {}, $(this).jqGrid("getGridParam"), a.addOptions);
			...
			editRow : function(a, b, c, d, e, f, g, h, i) {
				...
				return "object" === $.type(k[0]) ? j = k[0] : (void 0 !== b && (j.keys = b), $.isFunction(c) && (j.oneditfunc = c), $.isFunction(d) && (j.successfunc = d), void 0 !== e && (j.url = e), void 0 !== f && (j.extraparam = f), $.isFunction(g) && (j.aftersavefunc = g), $.isFunction(h) && (j.errorfunc = h), $.isFunction(i) && (j.afterrestorefunc = i)), j = $.extend(!0, {
						...
						h.grid && (e = $(h).jqGrid("getInd", a, !0), e !== !1 && (g = $.isFunction(j.beforeEditRow) ? j.beforeEditRow.call(h, j, a) : void 0, void 0 === g && (g = !0), g && (d = $(e).attr("editable") || "0", "0" !== d || $(e).hasClass("not-editable-row") || (f = h.p.colModel, $('td[role="gridcell"]', e).each(function(d) {
							...
							if (e)
								c = $("span:first", this).html();else try {
				...
				if (void 0 === x && (x = !0), x) {
					if (l = $(o).attr("editable"), i.url = i.url || j.p.editurl, "1" === l) {
									...
									case "button":
										...
										try {
											if (!y.editoptions || !$.isFunction(y.editoptions.custom_value))
												throw "e1";
											if (q[k] = y.editoptions.custom_value.call(j, $(".customelement", this), "get"), void 0 === q[k])
												throw "e2"
										} catch (e) {
						...
						if (C = j.p.keyName === !1 ? D.id : j.p.keyName, q) {
							if (q[D.oper] = D.editoper, void 0 === q[C] || "" === q[C])
								q[C] = a;
							else if (o.id !== j.p.idPrefix + q[C]) {
								var F = $.jgrid.stripPref(j.p.idPrefix, a);
								if (void 0 !== j.p._index[F] && (j.p._index[q[C]] = j.p._index[F],
									delete j.p._index[F]
									), a = j.p.idPrefix + q[C], $(o).attr("id", a), j.p.selrow === E && (j.p.selrow = a), $.isArray(j.p.selarrrow)) {
							...
							if (void 0 === h && (h = !0), h) {
								...
								if (f >= 0) {
									if ($.isFunction($.fn.datepicker)) try {
										...
										} catch (i) {} $.each(e.p.colModel, function() {
	...
	$.jgrid.extend({
		...
		sortableRows : function(a) {
			return this.each(function() {
				...
				b.grid && (b.p.treeGrid || $.fn.sortable && (a = $.extend({
					...
					axis : "y",
					items : " > .jqgrow"
				}, a || {}), a.start && $.isFunction(a.start) ? (a._start_ = a.start,
				delete a.start
					) : a._start_ = !1, a.update && $.isFunction(a.update) ? (a._update_ = a.update,
				delete a.update
					) : a._update_ = !1, a.start = function(c, d) {
		...
		gridResize : function(opts) {
			return this.each(function() {
				...
				if ($t.grid && $.fn.resizable) {
					if (opts = $.extend({}, opts || {}), opts.alsoResize ? (opts._alsoResize_ = opts.alsoResize,
						delete opts.alsoResize
							) : opts._alsoResize_ = !1, opts.stop && $.isFunction(opts.stop) ? (opts._stop_ = opts.stop,
						delete opts.stop
		...
		pivotSetup : function(a, b) {
			...
			return this.each(function() {
					...
					if (r = $.isArray(j.xDimension) ? j.xDimension.length : 0, s = j.yDimension.length, t = $.isArray(j.aggregates) ? j.aggregates.length : 0, 0 === r || 0 === t)
		...
		jqPivot : function(a, b, c, d) {
			return this.each(function() {
				function e(a) {
					var d,
						e = jQuery(f).jqGrid("pivotSetup", a, b),
					...
					}, e.groupOptions, c || {}));var i = e.groupHeaders;
					if (i.length)
					...
					var d,
						...
						l = function(a, b) {
							var d,
								e,
								f,
								g = $("<table class='" + i.rowTable + " ui-common-table'><tbody></tbody></table>"),
								h = $("<tr></tr>");
							...
							if ($(m).append(n), a && (h = c.p.jsonReader.subgrid, e = $.jgrid.getAccessor(a, h.root), void 0 !== e))
								for (f = 0; f < e.length; f++) {
									if (g = e[f], n = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), h.repeatitems === !0)
										for (h.cell && (g = g[h.cell]), l = 0; l < g.length; l++) k(n, g[l] || "&#160;", l);else {
			...
			return this.each(function() {
				...
				if (c.grid && c.p.treeGrid)
					for (var d, e, f, g, h, i, j, k, l = c.p.expColInd, m = c.p.treeReader.expanded_field, n = c.p.treeReader.leaf_field, o = c.p.treeReader.level_field, p = c.p.treeReader.icon_field, q = c.p.treeReader.loaded, r = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common; b > a;) {
						var s,
							t = $.jgrid.stripPref(c.p.idPrefix, c.rows[a].id),
							u = c.p._index[t];
			...
			return a.each(function() {
				b = b ? $(b, a) : a, b.bind("mousedown", {
					...
					if (M = {
						...
						} catch (g) {} return $(document).mousemove($.jqDnR.drag).mouseup($.jqDnR.stop), !1
				})
			})
		},
		f = function(a) {
	...
	$.fmatter = {}, $.extend($.fmatter, {
		...
		var f = b;
		c = $.extend({}, $.jgrid.getRegional(this, "formatter"), c);try {
		...
		if (void 0 !== b.colModel.formatoptions ? (e = b.colModel.formatoptions.value, c = void 0 === b.colModel.formatoptions.separator ? ":" : b.colModel.formatoptions.separator, d = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter) : void 0 !== b.colModel.editoptions && (e = b.colModel.editoptions.value, c = void 0 === b.colModel.editoptions.separator ? ":" : b.colModel.editoptions.separator, d = void 0 === b.colModel.editoptions.delimiter ? ";" : b.colModel.editoptions.delimiter), e) {
			var g,
				h = (null != b.colModel.editoptions && b.colModel.editoptions.multiple === !0) == !0 ? !0 : !1,
				i = [];
		...
		if (void 0 !== j && $.isFunction(j))
			...
			var k,
				l = $.jgrid.getRegional(this, "formatter") || {};
			switch (g) {
			case "integer":
				...
				var addNode = function(hash, key, cnts, val) {
						if ("string" == typeof val)
							if (-1 !== val.indexOf("function"))
								val = eval("(" + val + ")");else switch (val) {
								case "__EMPTY_ARRAY_":
									val = [];
									break;case "__EMPTY_STRING_":
									val = "";
									break;case "false":
									val = !1;
									break;case "true":
